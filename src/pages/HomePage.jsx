      ...
      <section className="relative overflow-hidden border-b border-[#ead9d2] bg-gradient-to-b from-[#fffdf9] via-[#faf7f2] to-[#f8f0eb]">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pt-6 md:px-10 lg:px-16">
          <header className="flex items-center justify-between border-b border-[#ead9d2]/80 pb-4">
            <Link
              to="/"
              className="text-sm font-medium uppercase tracking-[0.2em] text-[#9f102d] transition hover:opacity-70"
            >
              RedLipsticks.com
            </Link>
        ...
        <div className="relative mx-auto grid max-w-7xl gap-14 px-6 py-14 md:px-10 lg:grid-cols-[1.02fr_0.98fr] lg:items-center lg:px-16 lg:py-24">
          <div>
            <img
              src="/kiss.png"
